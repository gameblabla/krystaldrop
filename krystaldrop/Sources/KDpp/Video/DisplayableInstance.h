...
public:
	...
	*/
	virtual void DisplayAlphaPart(int x, int y, int alpha, int xPart, int yPart, int widthPart, int heightPart)=0;

	/**
		Displays the sprite with full poarameter passing: the coordinates color and alpha of each corner!
	*/
	virtual void DisplayFullParameters(int x1, int y1, int r1, int g1, int b1, int alpha1, int x2, int y2, int r2, int g2, int b2, int alpha2, int x3, int y3, int r3, int g3, int b3, int alpha3, int x4, int y4, int r4, int g4, int b4, int alpha4)=0;
