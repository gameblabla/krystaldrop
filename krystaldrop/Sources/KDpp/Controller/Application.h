...
/// Position of the controller added to the active list.
...
public:
    ...
    /** Gets the application singleton. */
    static KD_Application *GetApplication();

    /** Fetches 'global/video/opengl' */
    bool GetOpenGL();

    /** Fetches 'global/video/fullscreen' */
    bool GetFullScreen();

    /** Fetches 'global/sound/enable' */
    bool GetEnableSound();

    /** Fetches 'global/sound/frequency' */
    int  GetSoundFrequency();

    /** Fetches 'global/sound/bits' */
    int  GetSoundBits();

    /** Fetches 'global/sound/stereo' */
    bool GetStereoSound();
...
public:
    ...
    */
    ...
    /**
        Enables a controller previously registered (puts the controller in the active list).
    ...
    */
    ...
    //{
    /**
        Disables an active controller (this removes the controller from the active list).
    */
